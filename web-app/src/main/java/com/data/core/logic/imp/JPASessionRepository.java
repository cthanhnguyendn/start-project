...
//
//import com.data.core.logic.SpringSessionRepository;
//import com.data.core.pojo.SessionAttributes;
...
//    Map<String,SessionEntity> sessionCache = new HashMap();
//
//    @Autowired
...
//        SessionEntity sessionEntity = sessionCache.get(id);
//        springSessionRepository.findOne(id);
...
//            return null;
//        }
//        sessionCache.put(id,sessionEntity);
//        return saved;
//    }
//
//    @Override
